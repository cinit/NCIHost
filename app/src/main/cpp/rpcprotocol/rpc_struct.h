...
static_assert(sizeof(RpcTransactionHeader) == 12, "RpcTransactionHeader size error");
static_assert(sizeof(EventTransactionHeader) == 12, "EventTransactionHeader size error");
